...
const Navbar = () => {
  ...
  return (
    <nav className="sticky z-50 h-[94px] flex items-center top-0 z-10 w-full mx-auto bg-white border-b border-opacity-10">
                ...
                {menus.map((menu) => (
                  <li key={menu.title} className="relative flex-col">
                    <ReactScrollLink
                      ...
                      offset={-150}
                      to={menu.id}
                      className="relative block py-5 font-sans font-light tracking-wide cursor-pointer text-md text-opacity-85"
              ...
              {menus.map((menu) => (
                <li key={menu.title} className="relative flex-col mb-2">
                  <ReactScrollLink
                    ...
                    offset={-150}
                    to={menu.id}
                    className="relative block py-2 cursor:pointer text-primary w-fit"
