...
import useUpdateProject from "@/lib/hooks/actions/useUpdateProject";
...
export function ProjectUpdateForm({ project, onCallback, onOpenChange }) {
        ...
        <footer className="flex justify-end w-full space-x-3">
          ...
          <Button disabled={isLoading} type="submit" className="w-auto px-8">
            ...
            {isLoading ? (
              ...
              <LucideIcon name="pen" size={14} className="mr-2" />
            )}{" "}
            Update
          </Button>
        </footer>
