...
import useCreateOrganization from "@/lib/hooks/actions/useCreateOrganization";
...
export function OrganizationCreateForm({ onCallback, onOpenChange }) {
  ...
  const onSubmit = async ({ name, description }) => {
    ...
    if (response && !response.error && response.organization) {
      setSelectedOrgId(response.organization.id);
    }
