            ...
            <WholePageContainer className="pt-32">
                ...
                <section className={"bg-white"}>
                    <div className={"m-auto container w-full lg:w-[100%] max-w-[1300px]"}>
                        <div className="">
                            <div className={"flex flex-col justify-center space-y-4 p-6 rounded-lg shadow-cardShadow"}>
                                <div className={'flex flex-col items-center lg:flex-row'}>
                                    <div
                                        className={"w-full lg:w-1/4 max-w-[260px]  rounded-sm gap-1 bg-primary flex items-center flex-col text-white p-6"}
                                    >
                                        <img className={'w-3/5 self-center'} src="/doctor-circle.png" />
                                        <p className="font-serif text-base font-medium text-center ">Dr. Loretta Russell, DO</p>
                                    ...
                                    <div className={'flex w-3/4 justify-between  flex-col'}>
                                        <div className={'py-5 flex flex-col md:flex-row items-center md:items-start'}>
